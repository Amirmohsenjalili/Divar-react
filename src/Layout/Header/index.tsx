...
import loc from "src/assets/images/location.svg";
...
import { toggle } from 'src/store/category/categorySlice';
import { themetoggle } from "src/store/theme/themeSlice";
import { Link } from "react-router-dom";
import { ThemeState, CategoryState } from './index.types';

const Navbar: React.FC = () => {

const dark = useSelector((state: ThemeState) => state.theme.dark)
const show = useSelector((state: CategoryState) => state.category.showButton)
